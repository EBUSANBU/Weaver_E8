...
<%
    ...
    /**
     * 流程待办拆分为待办不含抄送，抄送不含待办
     * upcoming: 0 待办不含抄送， 1 抄送不含待办
     * modified by 陈少鑫
     * 2020/3/23
     */
    String upcoming = Util.null2String(request.getParameter("upcoming"));
    System.out.println("WFSearchTemp==>upcoming:" + upcoming);
...
//跳转到wfserachResult后是否需要头
    ...
    boolean isopenofs = false;//requestutil.getOfsSetting().getIsuse() == 1;
    boolean showdone = false;//requestutil.getOfsSetting().getShowdone().equals("1");
    if (fromPDA.equals("1")) {
    ...
    if (method.equals("all")) {
        ...
        if (complete.equals("0")) {
            ...
            if (upcoming.equals("0")) { //待办不含抄送
                if (viewcondition == 3) {
                    whereclause += " and (t2.isremark = '5' or (t2.isremark = '0' and isprocessed is not null ))  and (t1.currentnodetype <> '3' or  (t2.isremark ='1' and t1.currentnodetype = '3'))  and (t1.deleted=0 or t1.deleted is null) and t2.islasttimes=1";
                } else if (viewcondition == 1 || viewcondition == 2 || viewcondition == 4) {
                    whereclause += " and (((t2.isremark='0' and (t2.takisremark is null or t2.takisremark=0 )) or t2.isremark in('1','5','7'))  or (t2.isremark = '0' and t2.isprocessed is null)) and (t1.deleted=0 or t1.deleted is null) and t2.islasttimes=1";
                } else {
                    whereclause += " and ((t2.isremark='0' and (t2.takisremark is null or t2.takisremark=0 )) or t2.isremark in('1','5','7'))  and (t1.deleted=0 or t1.deleted is null) and t2.islasttimes=1";
                }
                ...
                if (viewcondition == 1)
                    whereclause += " and t2.viewtype = '0' and t2.isremark != '5' and (t1.currentnodetype <> '3' or  (t2.isremark = '1' and t1.currentnodetype = '3'))  and t2.isprocessed is null ";
            ...
            } else if (upcoming.equals("1")) {  //抄送不含待办
                if (viewcondition == 3) {
                    whereclause += "and (t1.currentnodetype <> '3' or (t2.isremark in ('8', '9') and t1.currentnodetype = '3'))  and (t1.deleted=0 or t1.deleted is null) and t2.islasttimes=1";
                } else if (viewcondition == 1 || viewcondition == 2 || viewcondition == 4) {
                    whereclause += " and  t2.isremark in('8','9') and (t1.deleted=0 or t1.deleted is null) and t2.islasttimes=1";
                } else {
                    whereclause += " and t2.isremark in('8','9')  and (t1.deleted=0 or t1.deleted is null) and t2.islasttimes=1";
                }
                //whereclause += " and (t2.isremark in('1','5','8','9','7') or (t2.isremark = '0' and (t2.isprocessed is null or (t2.isprocessed <> '2' and t2.isprocessed <> '3')))) and (t1.deleted=0 or t1.deleted is null) and t2.islasttimes=1" ;
...
/*
            ...
            } else {  //原始代码 防止其他模块引用这个文件，url不含upcoming都归为此
                if (viewcondition == 3) {
...
//add by ben根据单据号得到流程
    ...
    if (method.equals("reqeustbywfidNode")) {
        ...
        //complete=0表示待办事宜
        if (complete.equals("0")) {
            if (upcoming.equals("1")){ //抄送
                if (whereclause.equals("")) {
                    whereclause += " ( t2.isremark in('8','9')) and t2.islasttimes=1";
                } else {
                    whereclause += " and ( t2.isremark in('8','9')) and t2.islasttimes=1";
                }
            } else if(upcoming.equals("0")){  //待办
                if (whereclause.equals("")) {
                    whereclause += " ((t2.isremark=0 and (t2.takisremark is null or t2.takisremark=0 )) or t2.isremark in('1','5','7')) and t2.islasttimes=1";
                } else {
                    whereclause += " and ((t2.isremark=0 and (t2.takisremark is null or t2.takisremark=0 )) or t2.isremark in('1','5','7')) and t2.islasttimes=1";
                }
            } else {
                if (whereclause.equals("")) {
                    whereclause += " ((t2.isremark=0 and (t2.takisremark is null or t2.takisremark=0 )) or t2.isremark in('1','5','8','9','7')) and t2.islasttimes=1";
            ...
            if (upcoming.equals("1")){
                ;
            } else if (upcoming.equals("0")){
                if (viewcondition == 1)
                    whereclause += " and t2.viewtype = '0' and (t1.currentnodetype <> '3' or  (t2.isremark = '1' and t1.currentnodetype = '3')) and t2.isprocessed is null and t2.isremark <> '5' and t2.isremark <> '8' and t2.isremark <> '9' ";
                else if (viewcondition == 2)
                    whereclause += " and t2.viewtype = '-1' and ((t2.isremark='0' and (t2.isprocessed is null or (t2.isprocessed<>'2' and t2.isprocessed<>'3'))) or t2.isremark='1' or t2.isremark='5' or t2.isremark='7') ";
                else if (viewcondition == 3)
                    whereclause += " and ((t2.isremark='0' and (t2.isprocessed='2' or t2.isprocessed='3'))  or t2.isremark='5') and t1.currentnodetype <> 3  ";
                else if (viewcondition == 4)
                    whereclause += " and t2.requestid in (select requestid from workflow_requestlog where logtype='s')  and t2.isremark != '8' and t2.isremark != '9'  ";
            } else {
                if (viewcondition == 1)
        ...
        //complete=3表示待办事宜，红色new标记
            ...
            if (upcoming.equals("1")){ //抄送
                if (whereclause.equals("")) {
                    whereclause += " ( t2.isremark in('8','9')) and  t2.viewtype=0 and t2.islasttimes=1 and (t2.isremark='8' or t2.isremark='9') ";
                } else {
                    whereclause += " and ( t2.isremark in('8','9')) and  t2.viewtype=0 and t2.islasttimes=1 and (t2.isremark='8' or t2.isremark='9') ";
                }
            } else if(upcoming.equals("0")){  //待办
                if (whereclause.equals("")) {
                    whereclause += " ((t2.isremark=0 and (t2.takisremark is null or t2.takisremark=0 )) or t2.isremark in('1','5','7')) and  t2.viewtype=0 and t2.islasttimes=1 and ((t2.isremark='0' and (t2.isprocessed is null or (t2.isprocessed<>'2' and t2.isprocessed<>'3'))) or t2.isremark='1' or t2.isremark='5' or t2.isremark='7') ";
                } else {
                    whereclause += " and ((t2.isremark=0 and (t2.takisremark is null or t2.takisremark=0 )) or t2.isremark in('1','5','7')) and  t2.viewtype=0 and t2.islasttimes=1 and ((t2.isremark='0' and (t2.isprocessed is null or (t2.isprocessed<>'2' and t2.isprocessed<>'3'))) or t2.isremark='1' or t2.isremark='5' or t2.isremark='7') ";
                }
            } else {
                if (whereclause.equals("")) {
                    whereclause += " ((t2.isremark=0 and (t2.takisremark is null or t2.takisremark=0 )) or t2.isremark in('1','5','8','9','7')) and  t2.viewtype=0 and t2.islasttimes=1 and ((t2.isremark='0' and (t2.isprocessed is null or (t2.isprocessed<>'2' and t2.isprocessed<>'3'))) or t2.isremark='1' or t2.isremark='8' or t2.isremark='9' or t2.isremark='5' or t2.isremark='7') ";
        ...
        //complete=4表示待办事宜，灰色new标记(反馈)
            ...
            if (upcoming.equals("1")){ //抄送
                if (whereclause.equals("")) {
                    whereclause += " ( t2.isremark in('8','9')) and  t2.viewtype=-1 and t2.islasttimes=1 and (t2.isremark='8' or t2.isremark='9') ";
                } else {
                    whereclause += " and ( t2.isremark in('8','9')) and  t2.viewtype=-1 and t2.islasttimes=1 and (t2.isremark='8' or t2.isremark='9') ";
                }
            } else if(upcoming.equals("0")){  //待办
                if (whereclause.equals("")) {
                    whereclause += " ((t2.isremark=0 and (t2.takisremark is null or t2.takisremark=0 )) or t2.isremark in('1','5','7')) and  t2.viewtype=-1 and t2.islasttimes=1 and ((t2.isremark='0' and (t2.isprocessed is null or (t2.isprocessed<>'2' and t2.isprocessed<>'3'))) or t2.isremark='1' or t2.isremark='5' or t2.isremark='7') ";
                } else {
                    whereclause += " and ((t2.isremark=0 and (t2.takisremark is null or t2.takisremark=0 )) or t2.isremark in('1','5','7')) and  t2.viewtype=-1 and t2.islasttimes=1 and ((t2.isremark='0' and (t2.isprocessed is null or (t2.isprocessed<>'2' and t2.isprocessed<>'3'))) or t2.isremark='1' or t2.isremark='5' or t2.isremark='7') ";
                }
            } else {
                if (whereclause.equals("")) {
                    whereclause += " ((t2.isremark=0 and (t2.takisremark is null or t2.takisremark=0 )) or t2.isremark in('1','5','8','9','7')) and  t2.viewtype=-1 and t2.islasttimes=1 and ((t2.isremark='0' and (t2.isprocessed is null or (t2.isprocessed<>'2' and t2.isprocessed<>'3'))) or t2.isremark='1' or t2.isremark='8' or t2.isremark='9' or t2.isremark='5' or t2.isremark='7') ";
    ...
    if (method.equals("reqeustByWfTypeAndComplete")) {
        ...
        if (complete.equals("0")) {
            if(upcoming.equals("1")){
                if (whereclause.equals("")) {
                    if (viewcondition == 3) {
                        whereclause += "  (t1.currentnodetype <> '3' or  (t2.isremark in ( '8', '9') and t1.currentnodetype = '3'))  and t2.islasttimes=1";
                    } else {
                        whereclause += " (t2.isremark in('8','9')) and t2.islasttimes=1";
                    }
                } else {
                    if (viewcondition == 3) {
                        whereclause += " and (t1.currentnodetype <> '3' or  (t2.isremark in ( '8', '9') and t1.currentnodetype = '3'))  and t2.islasttimes=1";
                    } else {
                        whereclause += " and (t2.isremark in('8','9')) and t2.islasttimes=1";
                    }
                }
                ...
                if (whereclause.equals("")) {
                    if (viewcondition == 3) {
                        whereclause += " ((t2.isremark='0' and (t2.isprocessed='2' or t2.isprocessed='3'))  or t2.isremark='5') and (t1.currentnodetype <> '3' or  (t2.isremark ='1' and t1.currentnodetype = '3'))  and t2.islasttimes=1";
                    } else {
                        whereclause += " ((t2.isremark=0 and (t2.takisremark is null or t2.takisremark=0 )) or t2.isremark in('1','5','7')) and t2.islasttimes=1";
                    }
                } else {
                    if (viewcondition == 3) {
                        whereclause += " and ((t2.isremark='0' and (t2.isprocessed='2' or t2.isprocessed='3'))  or t2.isremark='5') and (t1.currentnodetype <> '3' or  (t2.isremark ='1' and t1.currentnodetype = '3'))  and t2.islasttimes=1";
                    } else {
                        whereclause += " and ((t2.isremark=0 and (t2.takisremark is null or t2.takisremark=0 )) or t2.isremark in('1','5','7')) and t2.islasttimes=1";
                    }
                }
            ...
            if (upcoming.equals("1")){
                ...
                if (viewcondition == 1)
                    whereclause += " and t2.viewtype = '0' and t2.isremark != '5' and t2.isremark != '8' and t2.isremark != '9' and t2.isprocessed is null ";
                else if (viewcondition == 2)
                    whereclause += " and t2.viewtype = '-1'  and t2.isremark != '8' and t2.isremark != '9' ";
                    //else if(viewcondition == 3)
                    //whereclause += " and t2.isremark = '5'";
                else if (viewcondition == 4)
                    whereclause += " and t2.requestid in (select requestid from workflow_requestlog where logtype='s')  and t2.isremark != '8' and t2.isremark != '9' ";
