 ...
 */
    ...
    System.out.println("RequestViewAjaxCount==>upcoming:" + upcoming);
    ...
    if (logintype.equals("2"))
        username = Util.toScreen(CustomerInfoComInfo.getCustomerInfoname("" + user.getUID()), user.getLanguage());
    ...
    if (upcoming.equals("1")){ //抄送
        ...
        sqlsb.append("        isremark = '1' or isremark = '5'  or isremark = '7') ");
    } else {  //防止其他文件调用此 不带upcoming造成的错误
        sqlsb.append("	  where ( (isremark = '0' and (takisremark is null or takisremark=0)) or ");
    ...
    if (upcoming.equals("1")) { //chaosong
        sqlsb.append("	  where ( ");
        sqlsb.append("	        isremark = '8' or isremark = '9') ");
    } else if (upcoming.equals("0")){  //daiban
...
//    if(templist.size()==2){
    ...
    if (upcoming.equals("1")){
        ...
        sqlsb.append("        isremark = '5') and isremark = '-1' ");
    ...
    if (requestutil.getOfsSetting().getIsuse() == 1) {
        ...
        while (rs.next()) {
            ...
            while (RecordSet.next()) {
                ...
                String sqlos;
                if (upcoming.equals("1")){
                     sqlos = "select COUNT(requestid) from ofs_todo_data where workflowid=" + _wfid + " and userid=" + user.getUID() + " and isremark='0' and islasttimes=1 and 1=2 ";
                } else{  //非抄送
                     sqlos = "select COUNT(requestid) from ofs_todo_data where workflowid=" + _wfid + " and userid=" + user.getUID() + " and isremark='0' and islasttimes=1 ";
                }
                ...
                wfcountall += wfcount;
                if (upcoming.equals("1")){
                    sqlos = "select COUNT(requestid) from ofs_todo_data where workflowid=" + _wfid + " and userid=" + user.getUID() + " and isremark='0' and islasttimes=1 and viewtype=0 and 1=2  ";
                } else{  //非抄送
