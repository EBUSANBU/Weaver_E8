...
import weaver.conn.RecordSet_zyz;
...
public class SqlRunServiceImpl implements ISqlRunService {
	...
	private RetrunMessBean RecordSet2ReturnMessBean(RecordSet_zyz rs, boolean flag,SqlTypeEnum sqlTypeEnum) {
		RetrunMessBean messBean = new RetrunMessBean();
		List<Map<String,Object>> data = new ArrayList<Map<String,Object>>();
		if(!flag) {
			messBean.setMsg(rs.getExceptionMessage());
			messBean.setCode(1);
		} else {
			if (sqlTypeEnum == SqlTypeEnum.SELECT) {
